...
export const NOTIFICATION_TYPE_META: Record<string, NotificationMeta> = {
  ...
  incident_ticket:               { icon: 'assignment',      color: '#15803D', bg: '#BBF7D0' },
  incident_assigned:             { icon: 'assignment-ind',  color: '#15803D', bg: '#BBF7D0' },
  ...
  ticket_message:                { icon: 'chat-bubble',     color: '#15803D', bg: '#BBF7D0' },
  new_message:                   { icon: 'chat-bubble',     color: '#15803D', bg: '#BBF7D0' },
